$(document).ready(function(){
    ...
    $('.delete-keyword').click(function (e){
        var path = $(this).attr('data-delete-path');//recuperer le path 
        var keywordId = $(this).attr('data-keyword-id');// recuperer le id 
        var $keywordArea = $(this).closest('.keywordArea'); //je recuperre mes variables
