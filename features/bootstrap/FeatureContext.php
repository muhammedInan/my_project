...
class FeatureContext implements Context
{
    ...
    /**
     * @Then the response should be redirected to :page
     */
    public function isShouldBeRedirectedTo($page)
    {
    ...
    {
        if(false == strpos($this->response->getContent(), $content )){//getContent ca va me renvoyer tt le html de ma page il me compare avec $content
